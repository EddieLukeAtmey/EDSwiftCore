...
public extension Date {
    ...
    /// My custom date format with string, timezone, locale, calendar
    public func es_toString(format: String, timeZone: TimeZone = .current, locale: Locale = .current, cal: Calendar = .current) -> String {
